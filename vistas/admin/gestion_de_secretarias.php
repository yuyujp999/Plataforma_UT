...
<head>
    ...
    <link rel="stylesheet" href="../../css/admin/secretariasModales10.css" />
            ...
            <div class="modal">
                ...
                <form id="formNuevo">
                    <fieldset>
                        ...
                        <input type="tel" name="telefono" id="telefono" inputmode="numeric" pattern="\d*" maxlength="15"
