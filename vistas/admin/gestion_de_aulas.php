...
$permisos = [
    ...
    'eliminar' => $esAdmin,                 // Admin SÍ elimina
    'exportar' => $esAdmin || $esSecretaria,
];
...
<head>
    ...
    <title>Gestión de Aulas (Admin)</title>
...
<body>
    ...
    <!-- JS específico de Aulas para ADMIN -->
    <script src="../../js/admin/Aulas.js"></script>
</body>
