...
// Secretarías: crear/editar/toggle SÍ; eliminar NO
$permisos = [
    'crear' => $esAdmin || $esSecretaria,
    'editar' => $esAdmin || $esSecretaria,
    'eliminar' => $esAdmin, // solo Admin
];
...
<head>
    ...
    <title>Gestión de Ciclos Escolares (Secretarías)</title>
...
<body>
    ...
    <!-- MODAL: NUEVO (Admin y Secretarías) -->
    <?php if ($permisos['crear']): ?>
    ...
    <!-- MODAL: EDITAR (Admin y Secretarías) -->
    <?php if ($permisos['editar']): ?>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        searchInput?.addEventListener("input", () => goToPage(1));
        goToPage(1);
    });
    </script>
    ...
    <!-- JS específico para Secretarías (crear/editar/toggle, sin eliminar) -->
    <script src="../../js/secretarias/Ciclos.js"></script>
</body>
