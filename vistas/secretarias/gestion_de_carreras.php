...
// Obtener carreras (orden alfabético)
$stmt = $pdo->query("
    SELECT id_carrera, nombre_carrera, descripcion, duracion_anios, fecha_creacion
    FROM carreras
...
<head>
    ...
    <title>Gestión de Carreras (Secretarías)</title>
...
<body>
            ...
            <div class="page-title">
                ...
                <div class="action-buttons">
                    <?php if ($permisos['exportar']): ?>
                        <button class="btn btn-outline btn-sm" id="btnExportar">
            ...
            <div class="modal">
                ...
                <form id="formNuevo" autocomplete="off">
                    <fieldset>
                        ...
                        <input type="number" name="duracion_anios" id="duracion_anios" min="1" required>
                    </fieldset>
    ...
    <script>
        ...
        document.getElementById('buscarCarrera')?.addEventListener('keyup', function () {
            ...
            document.querySelectorAll('#tablaCarreras tbody tr').forEach(fila => {
    ...
    <!-- JS de secretarías (ojo al endpoint interno del archivo) -->
    <script src="../../js/secretarias/Carreras.js"></script>
</body>
