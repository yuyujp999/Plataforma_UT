...
<div class="nav-menu" id="menu"><div class="menuheading">Menú</div></div>
</div>
<!-- MAIN CONTENT -->
...
<span id="badgeChat" class="badgeMenu" style="display:inlineblock;"></span>
</div>
</div>
...
<input id="searchInput" type="text" placeholder="Buscar alumno o
docente...">
<button id="searchBtn"><i class="fa-solid fa-search"></i></button>
</div>
<div id="resultadosBusqueda" style="max-height:200px; overflow-y:auto;"
></div>
<!-- 🔵 Usuarios en línea -->
...
<!-- 💬 Chats activos -->
<h3 style="margin-top:15px;"><i class="fa-solid fa-comments"></i> Chats
activos</h3>
<div id="chatsActivos"><p class="placeholder">Cargando
chats...</p></div>
</div>
<!-- Área principal -->
<div class="chat-main">
...
accept="image/*,application/pdf,application/msword,application/vnd.openxmlfo
rmats-officedocument.wordprocessingml.document" hidden>
<button id="emojiBtn" class="emoji-btn">
<i class="fa-regular fa-face-smile"></i>
</button>
<div id="previewFile" class="preview-file" style="display:none;
padding:10px; background:#eee; border-radius:8px; margin-bottom:10px;">
</div>
