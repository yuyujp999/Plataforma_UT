  ...
  const menuConfig = {
    ...
    admin: [
      ...
      },
      {
        ...
        text: "Grados",
        path: "/Plataforma_UT/vistas/admin/gestion_de_grados.php",
      },
      {
        icon: "fas fa-book",
        text: "Materias",
      ...
      },
      {
        icon: "fas fa-calendar-alt",
        text: "Ciclos",
        path: "/Plataforma_UT/vistas/admin/gestion_de_ciclos.php",
      },
      {
        icon: "fas fa-chalkboard-teacher",
      ...
      },
      {
        ...
        text: "Calificaciones",
        path: "/Plataforma_UT/vistas/admin/gestion_de_calificaciones.php",
      },
      {
        icon: "fas fa-bell",
        text: "Notificaciones",
