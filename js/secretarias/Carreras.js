document.addEventListener("DOMContentLoaded", () => {
  ...
  // Botón "Nueva carrera" solo si hay permiso
  if (PERM.crear) {
  ...
  // ==========================
  const url = "../../controladores/secretarias/controller_carreras.php";
  ...
  // ==========================
  // 🗑️ ELIMINAR — solo Admin (seguro por backend, pero evitamos UI)
  // ==========================
  tablaCarrerasBody?.addEventListener("click", (e) => {
    ...
    if (!PERM.eliminar) {
      // Si por error dejaron el botón en HTML, evitamos acción aquí
    ...
    qs("#btnExportar")?.addEventListener("click", function () {
      ...
      setTimeout(() => {
        window.location.href =
          "../../controladores/secretarias/exportar_carreras.php?tipo=pdf";
        setTimeout(() => {
          Swal.close();
          Swal.fire({
            icon: "success",
