document.addEventListener("DOMContentLoaded", () => {
  ...
  // RUTAS para SECRETARÍAS
  const url = "../../controladores/secretarias/controller_asignar_docente.php";
  const exportUrl =
    "../../controladores/secretarias/exportar_asignaciones_docentes.php?tipo=pdf";
  ...
  // ===== (SIN ELIMINAR) – No se registra ningún listener para .btn-eliminar =====
